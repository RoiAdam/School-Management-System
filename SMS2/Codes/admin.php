        ...
        <div class="mid-content">
            <section>
                ...
                <div class="list-container">
                    ...
                    <a href="add_admin.php" class="btn btn-dark mb-3">Add New</a>
                    ...
                    <table class="table table-hover text-center">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th scope="col"><a class="alist" href="">User Role</a></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $row["as_uName"] ?>
                                </td>
                                <td>
                                    <?php echo $row["as_pWord"] ?>
                                </td>
                                <td>
                                    <?php echo $row["as_fName"] ?>
                                </td>
                                <td>
                                    <?php echo $row["as_lName"] ?>
                                </td>
                                <td>
                                    <?php echo $row["as_Address"] ?>
                                </td>
                                <td>
                                    <?php echo $row["as_pNum"] ?>
                                </td>
                                <td>
                                    <?php echo $row["ur_ID"] ?>
                                </td>
                                <td>
                                <a href="edit_admin.php?id=<?php echo $row["as_ID"] ?>" class="link-info"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                <a href="del.php?id=<?php echo $row["as_ID"] ?>" class="link-danger"><i class="fa-solid fa-trash fs-5"></i></a>
                                </td>
                            </tr>
                            <?php
                            }
