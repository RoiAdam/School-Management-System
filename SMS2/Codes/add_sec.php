...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `section`(`sec_ID`, `sec_Name`) VALUES (NULL,'$sec_Name')";

   $result = mysqli_query($conn, $sql);

   if ($result) {
      header("Location: section.php?msg=New record created successfully");
   } else {
...
<head>
    ...
    <title>School Management System/Add Section</title>
        ...
        <div class="mid-content">
            <section>
                ...
                <div class="text-center mb-4">
                    ...
                    <p>Complete the form below to add a new section</p>
                </div>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="sec_Name" placeholder="" required>
                        </div>
