...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `section` SET `sec_Name`='$sec_Name' WHERE `section`.`sec_ID` = $id";
...
<head>
    ...
    <title>School Management System/Edit Section</title>
    ...
    <div>
        ...
        <div class="mid-content">
            <section>
                ...
                <?php
                $sql = "SELECT * FROM `section` WHERE sec_ID = $id";
                $result = mysqli_query($conn, $sql);
                ...
                <div class="container d-flex justify-content-center">
                    <form action="" method="post" style="width:50vw; min-width:300px;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="sec_Name" value="<?php echo $row['sec_Name'] ?>">
                        </div>
