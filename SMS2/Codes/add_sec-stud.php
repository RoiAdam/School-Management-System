...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `section_student`(`ses_ID`, `stud_ID`, `sec_ID`) VALUES (NULL,'$stud_ID','$sec_ID')";

   $result = mysqli_query($conn, $sql);

   if ($result) {
      header("Location: sec-stud.php?msg=New record created successfully");
   } else {
...
<head>
    ...
    <title>School Management System/Add Section-Student</title>
        ...
        <div class="mid-content">
            <section>
                ...
                <div class="text-center mb-4">
                    <h3>Add New Section-Student</h3>
                    <p class="text-muted">Complete the form below to add a new section-student</p>
                </div>
                ...
                <div class="d-flex justify-content-center">
                    <form action="" method="post" style="width:40vw; min-width:300px;">
                        ...
                        <div class="mb-3">
                            ...
                            <td>
                                <select class="form-control input-sm" name="stud_ID" required>
