...
<head>
    ...
    <title>School Management System/Classroom</title>
    ...
    <div>
        ...
        <div class="mid-content">
            <section>
                ...
                <a href="add_croom.php" class="btn btn-dark">Add New</a>
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $row["cr_Name"] ?>
                            </td>
                            <td>
                                <?php echo $row["cr_Building"] ?>
                            </td>
                            <td>
                                <?php echo $row["cr_Floor"] ?>
                            </td>
                            <td>
                                <a href="edit_croom.php?id=<?php echo $row["cr_ID"] ?>" class="link-info"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                <a href="del.php?id=<?php echo $row["cr_ID"] ?>" class="link-danger"><i class="fa-solid fa-trash fs-5"></i></a>
                            </td>
                        </tr>
                        <?php
                        }
