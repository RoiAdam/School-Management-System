...
<head>
    ...
    <title>School Management System/Section-Schedule</title>
        ...
        <div class="mid-content">
            <section>
                ...
                <div class="list-container">
                    ...
                    <a href="add_sec-sched.php" class="btn btn-dark mb-3">Add New</a>
                    ...
                    <table class="table table-hover text-center">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th scope="col"><a class="alist" href="schedule.php">Schedule</a></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="edit_sec-sched.php?id=<?php echo $row["ss_ID"] ?>" class="link-info"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                <a href="del.php?id=<?php echo $row["ss_ID"] ?>" class="link-danger"><i class="fa-solid fa-trash fs-5"></i></a>
                                </td>
                            </tr>
                            <?php
                            }
