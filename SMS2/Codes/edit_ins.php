...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `instructor` SET `ins_fName`='$ins_fName',`ins_lName`='$ins_lName',`ins_Dept`='$ins_Dept' WHERE `instructor`.`ins_ID` = $id";
...
<head>
    ...
    <title>School Management System/Edit Instructor</title>
                    ...
                    <form action="" method="post" style="width:50vw; min-width:300px;">
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="ins_fName"
                                    value="<?php echo $row['ins_fName'] ?>">
                            </div>

                            <div class="col">
                                <label class="form-label">Lastname:</label>
                                <input type="text" class="form-control" name="ins_lName"
                                    value="<?php echo $row['ins_lName'] ?>">
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Email:</label>
                            <input type="text" class="form-control" name="ins_Dept" value="<?php echo $row['ins_Dept'] ?>">
                        </div>                                       
