...
if (isset($_POST["submit"])) {
   $firstname = $_POST['stud_fName'];
   $lastname = $_POST['stud_lName'];
   $gerder = $_POST['stud_Gender'];
   $email = $_POST['stud_Email'];
   $course = $_POST['stud_Course'];
   $year = $_POST['stud_Year'];

   $sql = "INSERT INTO `student`(`stud_ID`, `stud_fName`, `stud_lName`, `stud_Gender`, `stud_Email`, `stud_Course`, `stud_Year`) VALUES (NULL,'$firstname','$lastname','$gerder','$email','$course', '$year')";
...
<head>
    ...
    <title>School Management System/Add Student</title>
                    ...
                    <form action="" method="post" style="width:40vw; min-width:300px;">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="stud_fName" placeholder="Berto" required>
                            </div>

                            <div class="col">
                                <label class="form-label">Last Name:</label>
                                <input type="text" class="form-control" name="stud_lName" placeholder="Rich" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <td>
                                <select class="form-control input-sm" name="stud_Gender" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="stud_Email" placeholder="name@example.com">
                        </div>

                        <div class="mb-3">
                            <th><label class="form-label">Course:</label></th>
                            <td>
                                <select class="form-control input-sm" name="stud_Course" required>
                        ...
                        <div class="mb-3">
                            <th><label class="form-label">Year Level:</label></th>
                            <td>
                                <select class="form-control input-sm" name="stud_Year" required>
