...
<head>
    ...
    <title>School Management System/Section</title>
    ...
    <div>
        ...
        <div class="mid-content">
            <section>
                ...
                <a href="add_sec.php" class="btn btn-dark">Add New</a>
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_sec.php?id=<?php echo $row["sec_ID"] ?>" class="link-info"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                <a href="del.php?id=<?php echo $row["sec_ID"] ?>" class="link-danger"><i class="fa-solid fa-trash fs-5"></i></a>
                            </td>
                        </tr>
                        <?php
                        }
