...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `schedule` SET `sched_Time`='$sched_Time',`cs_ID`='$cs_ID',`ins_ID`='$ins_ID',`cr_ID`='$cr_ID' WHERE `schedule`.`sched_ID` = $id";
...
<head>
    ...
    <title>School Management System/Edit Schedule</title>
                ...
                <div class="container d-flex justify-content-center">
                    <form action="" method="post" style="width:50vw; min-width:300px;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="sched_Time" value="<?php echo $row['sched_Time'] ?>">
                        </div>

                        <div class="mb-3">
                            <th><label class="form-label">Subject:</label></th>
                            <td>
                                <select class="form-control input-sm" name="cs_ID" value="<?php echo $row['cs_ID'] ?>">
                                    <?php 
                                    include "db_conn.php";
                        ...
                        <div class="mb-3">
                            ...
                            <td>
                                <select class="form-control input-sm" name="ins_ID" value="<?php echo $row['ins_ID'] ?>">
                                    <?php 
                                    include "db_conn.php";
                        ...
                        <div class="mb-3">
                            ...
                            <td>
                                <select class="form-control input-sm" name="cr_ID" value="<?php echo $row['cr_ID'] ?>">
                                    <?php 
                                    include "db_conn.php";
