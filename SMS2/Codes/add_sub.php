...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `course_subject`(`cs_ID`, `cs_Code`, `cs_Title`, `cs_Units`, `cs_Hours`) VALUES (NULL,'$cs_Code','$cs_Title','$cs_Units','$cs_Hours')";
        ...
        <div class="mid-content">
            <section>
                ...
                <div class="text-center mb-4">
                    ...
                    <p>Complete the form below to add a new subject</p>
                </div>
                    ...
                    <form action="" method="post" style="width:40vw; min-width:300px;">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="cs_Code" placeholder="" required>
                            </div>

                            <div class="col">
                                <label class="form-label">Title:</label>
                                <input type="text" class="form-control" name="cs_Title" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="cs_Units" placeholder="" required>
                            </div>

                            <div class="col">
                                <label class="form-label">Hours:</label>
                                <input type="text" class="form-control" name="cs_Hours" placeholder="" required>
                            </div>
                        </div>
