    ...
    <div>
        ...
        <div class="mid-content">
            <section>
                ...
                <a href="add_stud.php" class="btn btn-dark">Add New</a>
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $row["stud_fName"] ?>
                            </td>
                            <td>
                                <?php echo $row["stud_lName"] ?>
                            </td>
                            <td>
                                <?php echo $row["stud_Gender"] ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="edit_stud.php?id=<?php echo $row["stud_ID"] ?>" class="link-info"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                <a href="sdelete.php?id=<?php echo $row["stud_ID"] ?>" class="link-danger"><i class="fa-solid fa-trash fs-5"></i></a>
                            </td>
                        </tr>
                        <?php
                        }
