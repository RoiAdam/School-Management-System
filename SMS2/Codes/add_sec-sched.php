...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `section_schedule`(`ss_ID`, `sec_ID`, `sched_ID`) VALUES (NULL,'$sec_ID','$sched_ID')";

   $result = mysqli_query($conn, $sql);

   if ($result) {
      header("Location: sec-sched.php?msg=New record created successfully");
   } else {
...
<head>
    ...
    <title>School Management System/Add Section-Schedule</title>
        ...
        <div class="mid-content">
            <section>
                ...
                <div class="text-center mb-4">
                    <h3>Add New Section-Schedule</h3>
                    <p class="text-muted">Complete the form below to add a new section-schedule</p>
                </div>
                ...
                <div class="d-flex justify-content-center">
                    <form action="" method="post" style="width:40vw; min-width:300px;">
                        ...
                        <div class="mb-3">
                            ...
                            <td>
                                <select class="form-control input-sm" name="sec_ID" required>
                        ...
                        <div class="mb-3">
                            <th><label class="form-label">Schedule:</label></th>
                            <td>
                                <select class="form-control input-sm" name="sched_ID" required>
                                    
                                    <?php 
                                    include "db_conn.php";

                                    $userrole = mysqli_query($conn, "SELECT * FROM schedule");
                                    while ($c = mysqli_fetch_array($userrole)) {
                                    ?>
                                   
                                    <option value="<?php echo $c['sched_ID']?>"><?php echo $c['sched_Time'] ?></option>
                                    <?php } ?>
                        ...
                        <div class="addbtn">
                            ...
                            <a href="sec-sched.php" class="btn btn-danger">Cancel</a>
                        </div>
