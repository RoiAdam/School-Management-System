        ...
        <div class="mid-content">
            <section>
                ...
                <div class="list-container">
                    ...
                    <a href="add_sched.php" class="btn btn-dark mb-3">Add New</a>
                    ...
                    <table class="table table-hover text-center">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th scope="col"><a class="alist" href="subject.php">Subject</a></th>
                                <th scope="col"><a class="alist" href="instructor.php">Instructor</a></th>
                                <th scope="col"><a class="alist" href="classroom.php">Classroom</a></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="edit_sched.php?id=<?php echo $row["sched_ID"] ?>" class="link-info"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                <a href="del.php?id=<?php echo $row["sched_ID"] ?>" class="link-danger"><i class="fa-solid fa-trash fs-5"></i></a>
                                </td>
                            </tr>
                            <?php
                            }
