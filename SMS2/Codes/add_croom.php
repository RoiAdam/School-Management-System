...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `classroom`(`cr_ID`, `cr_Name`, `cr_Building`, `cr_Floor`) VALUES (NULL,'$cr_Name','$cr_Building','$cr_Floor')";

   $result = mysqli_query($conn, $sql);

   if ($result) {
      header("Location: classroom.php?msg=New record created successfully");
   } else {
...
<head>
    ...
    <title>School Management System/Add Classroom</title>
        ...
        <div class="mid-content">
            <section>
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted">Complete the form below to add a new classroom</p>
                </div>
                    ...
                    <form action="" method="post" style="width:40vw; min-width:300px;">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="cr_Name" placeholder="" required>
                            </div>

                            <div class="col">
                                <label class="form-label">Building:</label>
                                <input type="text" class="form-control" name="cr_Building" placeholder="" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Floor:</label>
                            <input type="text" class="form-control" name="cr_Floor" placeholder="" required>
                        </div>
