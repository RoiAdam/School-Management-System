...
if (isset($_POST["submit"])) {
   $ins_fName = $_POST['ins_fName'];
   $ins_lName = $_POST['ins_lName'];
   $ins_Dept = $_POST['ins_Dept'];

   $sql = "INSERT INTO `instructor`(`ins_ID`, `ins_fName`, `ins_lName`, `ins_Dept`) VALUES (NULL,'$ins_fName','$ins_lName','$ins_Dept')";

   $result = mysqli_query($conn, $sql);

   if ($result) {
      header("Location: instructor.php?msg=New record created successfully");
   } else {
...
<head>
    ...
    <title>School Management System/Add Instructor</title>
        ...
        <div class="mid-content">
            <section>
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted">Complete the form below to add a new instructor</p>
                </div>
                    ...
                    <form action="" method="post" style="width:40vw; min-width:300px;">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="ins_fName" placeholder="Berto" required>
                            </div>

                            <div class="col">
                                <label class="form-label">Last Name:</label>
                                <input type="text" class="form-control" name="ins_lName" placeholder="Rich" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Department:</label>
                            <input type="text" class="form-control" name="ins_Dept" placeholder="" required>
                        </div>
