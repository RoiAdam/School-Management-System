...
<head>
    ...
    <title>School Management System/Instrutor</title>
        ...
        <div class="mid-content">
            <section>
                ...
                <div class="list-container">
                    ...
                    <a href="add_ins.php" class="btn btn-dark">Add New</a>
                    ...
                    <table class="table table-hover text-center">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo $row["ins_Dept"] ?>
                                </td>
                                <td>
                                    <a href="edit_ins.php?id=<?php echo $row["ins_ID"] ?>" class="link-info"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                    <a href="del.php?id=<?php echo $row["ins_ID"] ?>" class="link-danger"><i class="fa-solid fa-trash fs-5"></i></a>
                                </td>
                            </tr>
                            <?php
                        }
