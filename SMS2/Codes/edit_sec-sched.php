...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `section_schedule` SET `sec_ID`='$sec_ID',`sched_ID`='$sched_ID' WHERE `section_schedule`.`ss_ID` = $id";

  $result = mysqli_query($conn, $sql);

  if ($result) {
    header("Location: sec-shed.php?msg=Data updated successfully");
  } else {
...
<head>
    ...
    <title>School Management System/Edit Section-Schedule</title>
        ...
        <div class="mid-content">
            <section>
                ...
                <div class="text-center mb-4">
                    <h3>Edit Section-Schedule Information</h3>
                    <p class="text-muted">Click update after changing any information</p>
                </div>

                <?php
                $sql = "SELECT * FROM `section_schedule` WHERE ss_ID = $id";
                $result = mysqli_query($conn, $sql);
                ...
                <div class="container d-flex justify-content-center">
                    <form action="" method="post" style="width:50vw; min-width:300px;">
                        ...
                        <div class="mb-3">
                            ...
                            <td>
                                <select class="form-control input-sm" name="sched_ID" value="<?php echo $row['sched_ID'] ?>">
                                    <?php 
                                    include "db_conn.php";
