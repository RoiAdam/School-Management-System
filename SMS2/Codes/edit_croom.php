...
if (isset($_POST["submit"])) {
    ...
    $cr_Building = $_POST['cr_Building'];
    $cr_Floor = $_POST['cr_Floor'];

  $sql = "UPDATE `section` SET `cr_Name`='$cr_Name',`cr_Building`='$cr_Building',`sec_Ncr_Floorame`='$cr_Floor' WHERE `classroom`.`cr_ID` = $id";

  $result = mysqli_query($conn, $sql);

  if ($result) {
    header("Location: classroom.php?msg=Data updated successfully");
  } else {
...
<head>
    ...
    <title>School Management System/Edit Classroom</title>
    ...
    <div>
        ...
        <div class="mid-content">
            <section>
                ...
                <?php
                $sql = "SELECT * FROM `classroom` WHERE cr_ID = $id";
                $result = mysqli_query($conn, $sql);
                    ...
                    <form action="" method="post" style="width:50vw; min-width:300px;">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="cr_Name"
                                    value="<?php echo $row['cr_Name'] ?>">
                            </div>

                            <div class="col">
                                <label class="form-label">Building:</label>
                                <input type="text" class="form-control" name="cr_Building"
                                    value="<?php echo $row['cr_Building'] ?>">
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Floor:</label>
                            <input type="text" class="form-control" name="cr_Floor" value="<?php echo $row['cr_Floor'] ?>">
                        </div>
