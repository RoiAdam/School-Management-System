    ...
    <div>
        ...
        <div class="mid-content">
            <section>
                ...
                <a href="add_sub.php" class="btn btn-dark">Add New</a>
                ...
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $row["cs_Code"] ?>
                            </td>
                            <td>
                                <?php echo $row["cs_Title"] ?>
                            </td>
                            <td>
                                <?php echo $row["cs_Units"] ?>
                            </td>
                            <td>
                                <?php echo $row["cs_Hours"] ?>
                            </td>
                            <td>
                                <a href="edit_sub.php?id=<?php echo $row["cs_ID"] ?>" class="link-info"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                <a href="del.php?id=<?php echo $row["cs_ID"] ?>" class="link-danger"><i class="fa-solid fa-trash fs-5"></i></a>
                            </td>
                        </tr>
                        <?php
                        }
